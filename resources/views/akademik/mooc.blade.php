  ...
  <div class="card recent-sales overflow-auto">
    <div class="card-body">
      <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <div>
          <button class="btn btn-sm btn-success me-2" data-bs-toggle="modal" data-bs-target="#modalTambahMooc">
            <i class="bi bi-plus-circle"></i> Tambah MOOC
          </button>
          <button class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#modalImportMooc">
            <i class="bi bi-upload"></i> Import MOOC
          </button>
        </div>
      </div>

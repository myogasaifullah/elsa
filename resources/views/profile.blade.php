                        ...
                        <div class="tab-content pt-2">
                            <div class="tab-pane fade show active profile-overview" id="profile-overview">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-9 col-md-8">{{ $user->fakultas ? $user->fakultas->nama_fakultas : 'N/A' }}</div>
                                </div>

                                <div class="row">
                                    <div class="col-lg-3 col-md-4 label">Program Studi</div>
                                    <div class="col-lg-9 col-md-8">{{ $user->prodi ? $user->prodi->nama_prodi : 'N/A' }}</div>
                                </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        } = prodiSelect.querySelector('option[value="{{ $prodi->id }}"]');
        if (prodiOption {
                {
                    $prodi - > id
                }
            ...
            }.dataset.fakultas = '{{ $prodi->fakultas_id }}';
        }
        @endforeach
